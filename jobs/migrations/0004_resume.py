# Generated by Django 4.2.1 on 2023-11-20 14:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(blank=True, choices=[('本科', '本科'), ('硕士', '硕士'), ('博士', '博士'), ('其他', '其他')], max_length=135, verbose_name='学历')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('modified_date', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('candidate_introduction', models.TextField(blank=True, max_length=2048, verbose_name='自我介绍')),
                ('work_experience', models.TextField(blank=True, max_length=2048, verbose_name='工作经历')),
                ('project_experience', models.TextField(blank=True, max_length=2048, verbose_name='项目经历')),
