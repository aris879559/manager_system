# Generated by Django 4.2.1 on 2023-11-10 16:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_secore', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='初试分')),
                ...
                ('first_advantage', models.TextField(blank=True, max_length=2048, verbose_name='优势')),
                ('first_disadvantage', models.TextField(blank=True, max_length=2048, verbose_name='不足')),
                ('first_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('放弃', '放弃')], max_length=1024, verbose_name='初试结果')),
                ...
                ('second_pursue_of_excelence', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='追求卓越得分')),
                ...
                ('second_advantage', models.TextField(blank=True, max_length=2048, verbose_name='优势')),
                ('second_disadvantage', models.TextField(blank=True, max_length=2048, verbose_name='不足')),
                ('second_result', models.CharField(blank=True, choices=[('建议录用', '建议录用'), ('待定', '待定'), ('放弃', '放弃')], max_length=1024, verbose_name='复试结果')),
                ...
                ('second_remark', models.CharField(blank=True, max_length=256, verbose_name='复试备注')),
                ...
                ('hr_potebtial', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR发展潜力')),
                ('hr_stability', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR稳定性')),
                ('hr_advantage', models.TextField(blank=True, max_length=2048, verbose_name='优势')),
                ('hr_disadvantage', models.TextField(blank=True, max_length=2048, verbose_name='顾虑和不足')),
                ('hr_result', models.CharField(blank=True, choices=[('建议录用', '建议录用'), ('待定', '待定'), ('放弃', '放弃')], max_length=1024, verbose_name='HR复试结果')),
