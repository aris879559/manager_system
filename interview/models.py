...
class Candidate(models.Model):
    ...
    candidate_remark = models.CharField(max_length=135, blank=True, verbose_name=u'候选人备注信息')
    ...
    first_score = models.DecimalField(decimal_places=1,  null=True, max_digits=2, blank=True, verbose_name=u'初试分',
                                      help_text=u'1-5分，极优秀：4.5-5；优秀：4-4.4；良好：3.5-3.9；一般：3-3.4；较差: <3分')
    ...
    first_advantage = models.TextField(max_length=2048, blank=True, verbose_name=u'优势')
    first_disadvantage = models.TextField(max_length=2048, blank=True, verbose_name=u'不足')
    first_result = models.CharField(max_length=1024, choices=FIRST_INTERVIEW_RESULT_TYPE, blank=True, verbose_name=u'初试结果')
    ...
    second_pursue_of_excelence = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name=u'追求卓越得分')
    ...
    second_advantage = models.TextField(max_length=2048, blank=True, verbose_name=u'优势')
    second_disadvantage = models.TextField(max_length=2048, blank=True, verbose_name=u'不足')
    second_result = models.CharField(max_length=1024, choices=INTERVIEW_RESULT_TYPE, blank=True, verbose_name=u'复试结果')
    ...
    second_remark = models.CharField(max_length=256, blank=True, verbose_name=u'复试备注')
    ...
    hr_potebtial = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'HR发展潜力')
    hr_stability = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name=u'HR稳定性')
    hr_advantage = models.TextField(max_length=2048, blank=True, verbose_name=u'优势')
    hr_disadvantage = models.TextField(max_length=2048, blank=True, verbose_name=u'顾虑和不足')
    hr_result = models.CharField(max_length=1024, choices=INTERVIEW_RESULT_TYPE, blank=True, verbose_name=u'HR复试结果')
    ...
    class Meta:
        ...
        verbose_name = u'应聘者信息'
        verbose_name_plural = u'应聘者信息'

        permissions = [
            ("export","可以导出数据列表"),
            ("notify","通知面试官对候选人进行评估"),
        ]

    #Python2 优先使用这个方法，把对象转换成字符串： 如果没有__unicode__方法，就调用__str__方法
